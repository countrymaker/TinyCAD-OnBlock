...
BOOL CDlgUpdateBox::OnInitDialog()
{
	...
	//< cmaker
	m_Spice_Model.SetTabStops(16);
	CFont font;
	font.CreateFont(14, 6, 0, 0, FW_LIGHT, 0, 0, 0, DEFAULT_CHARSET, 0, 0, 0, 0, _T("Consolas"));
	m_Spice_Model.SetFont(&font, TRUE);
	//> cmaker
...
//< cmaker
BOOL CDlgUpdateBox::PreTranslateMessage(MSG* pMsg)
{
